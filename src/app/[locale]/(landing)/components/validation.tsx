              ...
              >
                ...
                <div className="relative h-full overflow-hidden rounded-2xl bg-white p-6 shadow-lg transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl">
                  ...
                  <div className="relative z-10 flex items-start gap-4">
                    {/* Icon */}
                    <div className="bg-linear-to-br from-primary to-secondary flex h-14 w-14 shrink-0 items-center justify-center rounded-xl shadow-lg transition-transform duration-300 group-hover:scale-105">
